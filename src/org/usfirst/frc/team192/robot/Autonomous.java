...
public class Autonomous {
	...
	private enum Mode {
		ONLY_FORWARD("drive forward only"), FORWARD_AND_PLACE_SWITCH(
				"drive forward only and place in switch (50% chance)"), // 50% chance of right side
		FORWARD_AND_PLACE_SCALE_SIDE(
				"drive forward and then to the side to place in scale (50% chance)"), PLACE_SWITCH_BOTTOM(
						"move to correct part of bottom switch to place"), PLACE_SWITCH_SIDE(
